...
//import com.cnpc.iam.java.web.auth.oauth.jersey.util.impl.Configure;
import com.cnpc.iam.java.web.auth.oauth.jersey.util.impl.ConfigureException;
import com.cnpc.iam.java.web.auth.oauth.jersey.util.impl.ConfigureRuntimeException;
import org.springframework.context.support.ClassPathXmlApplicationContext;
import org.testng.Assert;
import org.testng.annotations.Test;

public class ConsumerConfigureTest {

//    public static ConfigureService Configure;
    ...
    public static void main(String[] args) {
        ...
        ConfigureService Configure = (ConfigureService) context.getBean("configureService");
