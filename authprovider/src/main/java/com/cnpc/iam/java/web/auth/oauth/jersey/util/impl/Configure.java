...
import com.cnpc.iam.java.web.auth.oauth.jersey.util.ConfigureService;
...
public class Configure implements ConfigureService {

    private static String propertieName = "oauth.properties";
    private Properties props = new Properties();

    /**
     * 使用oauth.properties创建实例
     *
     * @throws IOException
     */
    public Configure() {
     ...
     * @param inStream
     */
    public Configure(InputStream inStream) {
        init(inStream);
    }
...
//     * @param propertieName
     * @throws IOException
     */
    public Configure(String propName) {
     ...
     */
    public String getLoginUrl(String tokenKeyAppNum, String tokenKeyRedirecturl, String appNum, String redirectUrlPar)  throws ConfigureException {
     ...
     * @throws ConfigureException
     */
    private String getPropertyVal(String propertyKey) throws ConfigureException {
